...
if (!keyPath) {
  console.log(
    "You need to specify a path to a service account keypair in environment variable DF_SERVICE_ACCOUNT_PATH. See README.md for details."
  );
  process.exit(1);
}
...
const projectId = process.env.DF_PROJECT_ID || "test-agent-kiek";
if (!projectId) {
  console.log(
    "You need to specify a project ID in the environment variable DF_PROJECT_ID. See README.md for details."
  );
  process.exit(1);
}
